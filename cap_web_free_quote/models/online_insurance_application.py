...
class OnlineInsuranceApplication(models.Model):
    ...
    question_31 = fields.Char(
        string="Have you ever had a professional license suspended or revoked, or is such license currently under review?")
    ...
    question_47 = fields.Char(string="Is Carrier 1 employer paid?")
    question_48 = fields.Char(string="Is Carrier 2 employer paid?")
    question_49 = fields.Char(
        string="Will you be replacing any of your existing coverage?")
    question_50 = fields.Char(
        string="Do you want to provide any additional details regarding your current coverage?")
    question_51 = fields.Char(
        string="Have you used tobacco or nicotine products in any form within the last 5 years?")
    question_52 = fields.Char(
        string="Have you ever applied for insurance or reinstatement which has been: Declined, Postponed, Rated, or Modified?")
    question_53 = fields.Char(
        string="Have you ever received or claimed disability benefits for any injury, sickness or impaired condition?")
    question_54 = fields.Char(
        string="Have you ever made any flights as a pilot, student pilot, or crew member of any aircraft?")
    question_55 = fields.Char(
        string="Have you been convicted of a moving violation, had any traffic accidents, or had a driver's license revoked or suspended within the past 5 years?")
    question_56 = fields.Char(
        string="Have you ever been charged with, or convicted of, or currently awaiting trial on the violation of any criminal law?")
    question_57 = fields.Char(
        string="Do you belong to or intend to join the military in the next two years?")
    question_58 = fields.Char(
        string="Engaged in or plan to engage in the next two years in any form of the following: Motorized Racing, Parachuting/Skydiving, Martial Arts, Scuba Diving, Mountain Climbing?")
    ...
    question_73 = fields.Char(
        string="Have you ever been treated or diagnosed as having diabetes, elevated blood sugar, thyroid, pituitary, adrenal or any other endocrine (glandular) disorders?")
    question_74 = fields.Char(
        string="Have you ever been treated or diagnosed as having breast, reproductive organ or prostate disorder?")
    question_75 = fields.Char(
        string="Have you ever had a C-section, miscarriage, or complication of pregnancy?")
    question_76 = fields.Char(
        string="Have you ever been treated or diagnosed as having a mass, polyp, cyst, tumor or cancer?")
    question_77 = fields.Char(
        string="Have you ever been treated or diagnosed as having allergies, skin disorders, anemia, bleeding, clotting, or other blood disorder?")
    question_78 = fields.Char(
        string="Have you ever been treated or diagnosed as having anxiety, depression, stress, ADHD, eating disorder or other psychiatric or mental health disorders?")
    question_79 = fields.Char(
        string="Have you ever been treated or diagnosed as having chronic fatigue, chronic pain, fibromyalgia, or fever of unknown cause?")
    ...
    question_84 = fields.Char(
        string="In the last 10 years have you used marijuana, cocaine, heroin, barbiturates, tranquilizers, hallucinogens, amphetamines, narcotics, or any other drug, except as legally prescribed by a physician?")
    question_85 = fields.Char(
        string="In the last 10 years have you sought, received or been advised to seek medical treatment from a licensed medical profession, counseling or participation in a support group for the use of alcohol or illegal drugs?")
    question_86 = fields.Char(
        string="Please provide details to any of the above questions where you answered ""yes")
    question_87 = fields.Char(
    ...
    question_94 = fields.Char(string="Is your mother still living?")
    question_95 = fields.Char(
        string="If Yes, how old is she - If No, At what age did she die and what was her cause of death?")
    question_96 = fields.Char(string="Are all your siblings still living?")
    question_97 = fields.Char(
        string="If Yes How old is each one - If No, at what age did they die and what was their cause of death?")
