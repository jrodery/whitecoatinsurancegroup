...
class OnlineInsuranceApplication(models.Model):
    ...
    question_30 = fields.Selection(select_boolean,
    ...
    question_47 = fields.Selection(select_boolean,
                                   string="Is Carrier 1 employer paid?")
    question_48 = fields.Selection(select_boolean,
    ...
    def create(self, vals):
        ...
        # self.send_form_mail()
        return super(OnlineInsuranceApplication, self).create(vals), self.sudo().send_form_mail()
